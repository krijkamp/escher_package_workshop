...
Rstudio will present the following in the Help tab. ![](images/help_file_function.png) Now that we have the key functions and documentation, we can upload this to GitHub for the world to see and use.
